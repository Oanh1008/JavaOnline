...
public class Ex05 {
	public static void main(String[] args) {
		...
		List<Apple>apple200= findApples(inventory,apple->apple.getWeight()>150);
		...
		List<Apple>apple150= findApples(inventory,apple->apple.getWeight()<200);
		...
		List<Apple>appleG400=findApples(inventory,apple->apple.getWeight()>400 && "red".equals(apple.getColor()));
	 ...
	 * >> lambda expression syntax (parameter -> {body}) this is used to override abtract class in Function interface
	 */
