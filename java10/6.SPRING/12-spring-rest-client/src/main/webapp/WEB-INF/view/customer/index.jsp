	...
	<header>
		<nav class="navbar navbar-light bg-light">
			<div class="container-fluid">
				...
				<form:form class="d-flex" action="${contextPath}/customer?page=${param.page}"
					method="GET">
			...
			<tbody>
				<c:forEach items="${customers}" var="customer">
					<tr>
						...
						<a
							href="${contextPath}/customer/delete?id=${customer.id}" class="btn btn-danger btn-sm"
			...
			<ul class="pagination">
				...
				<c:forEach var="page" begin="1" end="${totalPages}">
					<li class="page-item"><c:choose>
							...
							<c:otherwise><a href="${contextPath}/customer?page=${page}" class="page-link">${page}</a></c:otherwise>
						</c:choose> 
					</li>
				</c:forEach>
